...
.. |docs| image:: https://readthedocs.org/projects/pytrim/badge/?version=latest
    :target: https://pytrim.readthedocs.io/en/latest/?badge=latest
    :alt: Documentation Status

.. |travis| image:: https://travis-ci.org/pytrim/pytrim.svg?branch=master
    :target: https://travis-ci.org/pytrim/pytrim
    :alt: Travis-CI Build Status

.. |coveralls| image:: https://coveralls.io/repos/github/pytrim/pytrim/badge.svg?branch=master
    :target: https://coveralls.io/github/pytrim/pytrim?branch=master
